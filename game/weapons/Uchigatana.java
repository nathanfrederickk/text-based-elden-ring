...
import game.actions.attack.UnsheatheAction;
import game.enums.ItemType;

public class Uchigatana extends WeaponItem implements SellAble, PurchaseAble{
    public Uchigatana(){
        super("Uchigatana", ')', 115, "cuts", 80);
        this.addCapability(ItemType.UCHIGATANA);
    }
