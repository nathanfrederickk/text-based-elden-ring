...
public class GiantCrayFishPincher extends WeaponItem {
    /**
     * Constructor of GiantCrayFishPincher item class , set attribute (name,displayChar,damage,damage,verb,and hit rate)
     * togle portability to false so this item won't be dropped upon wielder death
     */
    public GiantCrayFishPincher(){
        super("Giant Crayfish Pincer",'c',527,"slam",100);
