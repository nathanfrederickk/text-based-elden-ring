...
public class GiantCrabPincher extends WeaponItem {

    /**
     * Constructor of GiantCrabPincher item class , set attribute (name,displayChar,damage,damage,verb,and hit rate)
     * togle portability to false so this item won't be dropped upon wielder death
     */
    public GiantCrabPincher(){
        super("Crab Pincher",'P',208,"slam",90);
